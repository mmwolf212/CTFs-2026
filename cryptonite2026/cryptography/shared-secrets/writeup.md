...
This challenge presents us with a relatively straightforward RSA setup, but with a glaring vulnerability: the same plaintext message has been encrypted twice using two different public exponents under the same modulus. This is vulnerable to what is known as a Common Modulus Attack.
